    ...
    <section className="py-16 sm:py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h2 className="text-3xl sm:text-4xl font-extrabold text-[#004D2D]">Why choose SJMPC loans</h2>
        ...
        <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {benefits.map((b, idx) => (
            ...
            >
              <div className="w-12 h-12 rounded-2xl bg-[var(--sjmpc-green)]/10 text-[var(--sjmpc-green)] flex items-center justify-center border border-[var(--sjmpc-green)]/20">
                <b.icon className="w-6 h-6" aria-hidden="true" />
              </div>
              <h3 className="mt-4 text-lg font-extrabold text-[#004D2D]">{b.title}</h3>
