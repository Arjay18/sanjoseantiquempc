...
export default function MiagaoBranchPage() {
  ...
  const staffData = {
    branchManager: [
      { name: "RAYMUND V. HUELAR", position: "Branch Manager", icon: Crown, priority: 1, color: "from-amber-500 to-yellow-600", image: "/staff/raymund-huelar.jpg" }
    ],
    branchStaff: [
      { name: "RHEA ANN MARIEL S. CONDESA", position: "Bookkeeper", icon: BookOpen, color: "from-green-500 to-green-600", image: "/staff/rhea-condesa.jpg" },
      { name: "RAMAH H. EGIDA", position: "Clerk, Loan Processor", icon: FileText, color: "from-blue-500 to-blue-600", image: "/staff/ramah-egida.jpg" },
      { name: "JERMIE M. GARCESA", position: "CIBI", icon: Shield, color: "from-purple-500 to-purple-600", image: "/staff/jermie-garcsea.jpg" },
      { name: "ROMMEL JULINE N. AREVALO", position: "Driver, Maintenance Clerk", icon: Settings, color: "from-yellow-500 to-yellow-600", image: "/staff/rommel-arevalo.jpg" },
      { name: "JOHANNA MAE G. CEÑIZA", position: "Clerk, Loan Monitoring", icon: TrendingUp, color: "from-pink-500 to-pink-600", image: "/staff/johanna-ceniza.jpg" },
      { name: "D'ARTAGNAN N. TAJONERA, JR.", position: "IT", icon: Target, color: "from-indigo-500 to-indigo-600", image: "/staff/dartagnan-tajonea.jpg" },
      { name: "ANJANETTE C. CAPITLE", position: "Teller", icon: DollarSign, color: "from-red-500 to-red-600", image: "/staff/anjanette-capitle.jpg" },
      { name: "LESLEE RICHANN RENDON", position: "Clerk", icon: FileText, color: "from-teal-500 to-teal-600", image: "/staff/leslee-rendon.jpg" },
      { name: "RJ JAN M. FABILLO", position: "Account Officer", icon: Briefcase, color: "from-orange-500 to-orange-600", image: "/staff/rj-fabillo.jpg" },
      { name: "BABY ANGEL A. GAMOS", position: "Clerk", icon: UserCheck, color: "from-cyan-500 to-cyan-600", image: "/staff/baby-gamos.jpg" },
      { name: "ALMA MARIE V. MESAYRA", position: "Marketing Assistant", icon: Megaphone, color: "from-lime-500 to-lime-600", image: "/staff/alma-mesayra.jpg" },
      { name: "ALBERT M. MOLEJONA", position: "Account Officer (JO)", icon: Briefcase, color: "from-emerald-500 to-emerald-600", image: "/staff/albert-molejona.jpg" },
      { name: "KLENT CONTEMPLACION", position: "Account Officer (JO)", icon: Briefcase, color: "from-violet-500 to-violet-600", image: "/staff/klent-contemplacion.jpg" }
    ]
  };
            ...
            <div className="group relative bg-white/10 backdrop-blur-3xl rounded-3xl p-8 shadow-2xl border border-white/20 overflow-hidden transition-all duration-500 hover:shadow-[0_25px_50px_-12px_rgba(0,0,0,0.25)] hover:scale-[1.02] hover:bg-white/15 animate-fade-in">
              ...
              <div className="relative z-10 text-center">
                ...
                <h3 className="font-bold text-gray-900 mb-2 text-xl leading-tight group-hover:text-gray-800 transition-colors duration-300">
                  Miagao Branch Office
                </h3>

                <p className="text-gray-600 text-sm leading-relaxed">
                  Serving the Miagao community with excellence and dedication.
                </p>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-20 animate-fade-in">
          ...
          <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed mb-8">
            Meet the dedicated team serving our Miagao community with excellence and commitment.
          </p>
