...
import { 
  ...
  AlertTriangle, CheckCircle, TrendingUp, Clock, Shield, 
  PiggyBank, BarChart3, Calendar, Bell, Settings, LogOut,
  ChevronRight, Plus, Eye, Upload, Package
} from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            ...
            <div className="flex gap-3">
              <Link 
                href="/loan-status" 
                className="flex items-center gap-2 bg-white/20 hover:bg-white/30 backdrop-blur rounded-xl px-4 py-2 transition"
              >
              ...
              <div className="sticky top-0 bg-white border-b border-gray-100 p-6 rounded-t-3xl">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    ...
                    <p className="text-gray-500 text-sm mt-1">Complete the form below to apply for a loan</p>
                  </div>
                  <button
                ...
                <div className="flex items-center justify-between px-4">
                  {steps.map((step, index) => (
                    <div key={index} className="flex flex-col items-center flex-1">
                      ...
                      <span className={`text-xs mt-2 text-center hidden sm:block ${currentStep === index + 1 ? 'text-blue-600 font-medium' : 'text-gray-500'}`}>
                        {step.title}
                      </span>
                    </div>
                  ))}
