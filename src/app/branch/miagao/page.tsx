...
export default function MiagaoBranchPage() {
  ...
  useEffect(() => {
    setApplications([
      // Example application
      // { id: '1', name: 'Juan Dela Cruz', pbNo: 'PB123', contactNo: '09123456789', loanAmount: 10000, loanType: 'Personal', status: 'pending', createdAt: '', idFile: '', depositSlipOrEwallet: '', memberWithIDAndSlip: '' }
    ]);
  }, []);
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          {/* ...existing code for other cards, table, and modal... */}
        </div>
      </div>
      {previewModalApp && (
                    ...
                    <div className="flex-1">
                      <div className="flex items-center">
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-gray-500">PB#: {application.pbNo} {application.contactNo ? `| ${application.contactNo}` : ''}</p>
                          <p className="text-sm text-gray-500">
                            {application.loanType ? `${application.loanType} - ₱${application.loanAmount?.toLocaleString()}` : ''}
                          </p>
                        </div>
                        <div className="ml-4">
